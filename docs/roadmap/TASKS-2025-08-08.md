...
1) Repo foundations and governance
- Deliverables:
  - .github/workflows/ci.yml — CI (lint, test, typecheck, build)
  - .editorconfig
  - CODEOWNERS, CONTRIBUTING.md, SECURITY.md
  - docs/adr/ADR-000-template.md
- Acceptance Criteria:
  - CI runs on PRs to main; blocks on failures
  - Pre-commit hooks run lint/format
- Notes:
  - Use GitHub Actions matrix for Node LTS; conventional commits in PR guidance
